  ...
  return (
    <main className="page-in" style={{ background: "#000" }}>
      ...
      <section style={{ minHeight: "100svh", background: "#000", position: "relative", overflow: "hidden", display: "flex", alignItems: "stretch" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: isMobile ? "5rem 1.5rem 3rem" : "10rem 6rem 6rem", maxWidth: 680 }}>
          ...
          <h1 style={{ fontSize: isMobile ? "clamp(2.6rem,10vw,3.5rem)" : "clamp(3rem,5vw,6rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.04em", lineHeight: 1, marginBottom: "1.25rem", opacity: 0, animation: "fadeUp 1.1s ease .4s forwards" }}>
            Rafael<br />Guimarães.
          </h1>
          <p style={{ fontSize: isMobile ? ".95rem" : "1.1rem", color: "rgba(255,255,255,.65)", lineHeight: 1.75, maxWidth: 420, marginBottom: "2rem", opacity: 0, animation: "fadeUp .9s ease .6s forwards" }}>
