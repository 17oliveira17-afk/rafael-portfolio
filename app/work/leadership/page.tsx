...
/* ── SVG Icons ── */
const IconCalendar = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ec6b86" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const IconAward = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ec6b86" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const IconBot = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ec6b86" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function Label({ children }: { children: ReactNode }) {
  return <p style={{ fontSize: ".68rem", fontWeight: 600, letterSpacing: ".2em", textTransform: "uppercase", color: "#ec6b86", marginBottom: "1.5rem" }}>{children}</p>;
}
function Divider() {
...
function Tag({ children, bg = "rgba(236,107,134,.15)", border = "rgba(236,107,134,.3)", color = "#ec6b86" }: { children: ReactNode; bg?: string; border?: string; color?: string }) {
...
function Quote({ text, author, role }: { text: string; author: string; role: string }) {
  return (
    <div style={{ background: "rgba(236,107,134,.06)", border: "1px solid rgba(236,107,134,.18)", borderRadius: 20, padding: "2.25rem" }}>
...
/* ── Icon box ── */
function IconBox({ icon, color = "rgba(236,107,134,.2)" }: { icon: ReactNode; color?: string }) {
  return (
...
const GLOWS: Record<string, string> = {
  blue:   "radial-gradient(ellipse 60% 58% at 50% 42%, rgba(236,107,134,.42), transparent 68%)",
      ...
      <figure style={{ margin: 0, position: "relative" }}>
        ...
        {(eyebrow || caption) && (
          <figcaption style={{ marginTop: ".7rem", textAlign: "center", maxWidth: 620, marginLeft: "auto", marginRight: "auto", position: "relative", zIndex: 1 }}>
            {eyebrow && <span style={{ display: "block", fontSize: ".62rem", fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".4rem" }}>{eyebrow}</span>}
...
function SideShot({ src, alt, side, eyebrow, title, body, glow, isMobile }:
  ...
  const txt = (
    <div style={{ maxWidth: 430 }}>
      <p style={{ fontSize: ".62rem", fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".9rem" }}>{eyebrow}</p>
  ...
  return (
    <ScrollReveal type="in">
      <div style={{
        ...
        <div style={{ position: "relative", width: 46, height: 46, borderRadius: 12, background: "rgba(236,107,134,.14)", border: "1px solid rgba(236,107,134,.28)", display: "flex", alignItems: "center", justifyContent: "center", color: "#ec6b86" }}>{icon}</div>
  ...
  return (
    <main className="page-in dark-cursor" style={{ background: "#000", "--blue": "#ec6b86", "--blue-hover": "#d95c76" } as React.CSSProperties}>
          ...
          <ScrollReveal>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.25rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "1.25rem" : "3rem", flexWrap: "wrap", justifyContent: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", color: "#ec6b86" }}><IconArrow /></div>
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: isMobile ? "5rem" : "9rem", fontWeight: 700, color: "#f5f5f7", letterSpacing: "-.06em", lineHeight: 1 }}>
                    <Counter to={3} suffix="w" />
                  </div>
                  <div style={{ fontSize: ".7rem", color: "#ec6b86", marginTop: ".4rem", letterSpacing: ".1em", textTransform: "uppercase", fontWeight: 600 }}>After</div>
                </div>
              </div>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            ...
            <ScrollReveal delay={0}>
              <div style={{ padding: isMobile ? "2rem 1.5rem" : "2.5rem", background: "rgba(236,107,134,.05)", border: "1px solid rgba(236,107,134,.18)", borderRadius: 24 }}>
                <div style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
                  <IconBox icon={<IconCalendar />} color="rgba(236,107,134,.2)" />
                  <div>
                    <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".15em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".5rem" }}>01 — Sprint Planning</p>
                    ...
                    <div style={{ display: "flex", gap: ".6rem", marginTop: "1.25rem", flexWrap: "wrap" }}>
                      {["Weekly planning", "Capacity mapping", "Scope protection", "3-week cadence"].map((t, i) => (
                        <span key={i} style={{ fontSize: ".68rem", fontWeight: 600, padding: ".28rem .8rem", borderRadius: 8, background: "rgba(236,107,134,.12)", border: "1px solid rgba(236,107,134,.25)", color: "#ec6b86" }}>{t}</span>
                      ))}
                    </div>
                  </div>
                </div>
            ...
            <ScrollReveal delay={60}>
              <div style={{ padding: isMobile ? "2rem 1.5rem" : "2.5rem", background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 24 }}>
                <div style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
                  ...
                  <div>
                    <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".15em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".5rem" }}>02 — Design Roadmap</p>
            ...
            <ScrollReveal delay={100}>
              <div style={{ padding: isMobile ? "2rem 1.5rem" : "2.5rem", background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 24 }}>
                <div style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".15em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".5rem" }}>03 — AI & Design Jira</p>
            ...
            <ScrollReveal delay={140}>
              <div style={{ padding: isMobile ? "2rem 1.5rem" : "2.5rem", background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 24 }}>
                <div style={{ display: "flex", gap: "1.25rem", alignItems: "flex-start" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".15em", textTransform: "uppercase", color: "#ec6b86", marginBottom: ".5rem" }}>04 — 7 Ceremonies</p>
      ...
      <FullBleedShot src="/work/tw/system-board.png" alt="System-level design board — the full credit flow mapped end to end"
        ...
        headline={<>From chaos<br />to <span style={{ color: "#ec6b86" }}>clarity.</span></>}
        ...
        <div className="aurora-content">
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0 1.5rem" : "0 6rem" }}>
            <ScrollReveal>
              ...
              <h2 style={{ fontSize: isMobile ? "clamp(1.6rem,6vw,2.4rem)" : "clamp(1.8rem,4vw,3rem)", fontWeight: 700, color: "#f5f5f7", letterSpacing: "-.03em", marginBottom: "1rem", lineHeight: 1.1 }}>
                System thinking,<br /><span style={{ color: "#ec6b86" }}>made visible.</span>
              </h2>
          ...
          <ScrollReveal delay={80}>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "1rem", marginBottom: "1.25rem" }}>
              {[
                ...
                { track: "Delivery Track", role: "UI design, handoff to Engineering, client alignment", icon: <IconArrow />, color: "rgba(236,107,134,.07)", border: "rgba(236,107,134,.22)" },
              ].map((t, i) => (
      ...
      <section style={{ padding: pad }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <ScrollReveal delay={80}>
            <div style={{ padding: isMobile ? "2.5rem 1.5rem" : "4rem", background: "linear-gradient(135deg, rgba(236,107,134,.1) 0%, rgba(236,107,134,.03) 100%)", border: "1px solid rgba(236,107,134,.22)", borderRadius: 28, textAlign: "center" }}>
              <p style={{ fontSize: ".68rem", fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase", color: "rgba(236,107,134,.75)", marginBottom: "2rem" }}>Delivery cycle reduction</p>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: isMobile ? "1.5rem" : "3.5rem", flexWrap: "wrap" }}>
                {[{ n: <Counter to={8} suffix="w" />, l: "Before" }, { n: <Counter to={3} suffix="w" />, l: "After" }, { n: <><Counter to={60} suffix="%" /></>, l: "Reduction" }].map((s, i) => (
                  <div key={i} style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: ".7rem", color: i === 0 ? "rgba(255,255,255,.3)" : "#ec6b86", marginTop: ".5rem", letterSpacing: ".1em", textTransform: "uppercase", fontWeight: 600 }}>{s.l}</div>
                  </div>
                ))}
              </div>
            </div>
