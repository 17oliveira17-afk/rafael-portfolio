...
function MediaPlaceholder({
  ...
  return (
    <div style={{
      ...
      border: "2px dashed rgba(255,102,0,.4)",
      borderRadius: 16,
      display: "flex",
      ...
      <code style={{ fontSize: ".75rem", color: "rgba(255,102,0,.7)", background: "rgba(255,102,0,.1)", padding: ".25rem .6rem", borderRadius: 6 }}>
        /public/{filename}
      </code>
      {hint && (
...
function Label({ children }: { children: ReactNode }) {
  return (
    <p style={{ fontSize: ".68rem", fontWeight: 600, letterSpacing: ".2em", textTransform: "uppercase", color: "#ff6600", marginBottom: "1.5rem" }}>
      {children}
    </p>
  );
}
  ...
  return (
    <main className="page-in" style={{ background: "#000" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 70% 60% at 20% 70%, rgba(255,102,0,.1) 0%, transparent 60%)", pointerEvents: "none" }} />
        <div style={{ maxWidth: 900, position: "relative", zIndex: 1 }}>
          <ScrollReveal>
            <div style={{ display: "flex", gap: ".75rem", flexWrap: "wrap", marginBottom: "2rem" }}>
              {["B2B", "Onboarding", "9 markets", "Solo designer"].map(t => (
                <span key={t} style={{ padding: ".3rem .9rem", border: "1px solid rgba(255,102,0,.3)", borderRadius: 100, fontSize: ".7rem", color: "rgba(255,255,255,.5)", letterSpacing: ".06em" }}>{t}</span>
              ))}
            </div>
            <h1 style={{ fontSize: isMobile ? "2.8rem" : "clamp(3rem,7vw,6.5rem)", fontWeight: 700, letterSpacing: "-.04em", lineHeight: .98, color: "#fff", marginBottom: "2rem" }}>
              Rappi Merchant<br />
              <em style={{ color: "#ff6600", fontStyle: "italic" }}>Onboarding.</em>
            </h1>
            ...
            <div style={{ display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
              <div>
                <p style={{ fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 700, color: "#ff6600", letterSpacing: "-.04em", lineHeight: 1 }}>2 weeks</p>
                <p style={{ fontSize: ".72rem", color: "rgba(255,255,255,.4)", marginTop: ".5rem", letterSpacing: ".1em", textTransform: "uppercase" }}>→ 2 days to open</p>
              </div>
              <div style={{ width: 1, background: "rgba(255,255,255,.1)", margin: "0 .5rem" }} />
              <div>
                <p style={{ fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 700, color: "#ff6600", letterSpacing: "-.04em", lineHeight: 1 }}>+53%</p>
                <p style={{ fontSize: ".72rem", color: "rgba(255,255,255,.4)", marginTop: ".5rem", letterSpacing: ".1em", textTransform: "uppercase" }}>Onboarding conversion</p>
              </div>
              <div style={{ width: 1, background: "rgba(255,255,255,.1)", margin: "0 .5rem" }} />
              <div>
                <p style={{ fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 700, color: "#ff6600", letterSpacing: "-.04em", lineHeight: 1 }}>+135%</p>
                <p style={{ fontSize: ".72rem", color: "rgba(255,255,255,.4)", marginTop: ".5rem", letterSpacing: ".1em", textTransform: "uppercase" }}>Lead verification</p>
              </div>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "5rem", alignItems: "start" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem,3.5vw,3.2rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem" }}>
              30% of merchants<br />never made it past<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>the menu step.</em>
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "rgba(255,255,255,.06)", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(255,255,255,.06)" }}>
              {[
                ...
                <div key={i} style={{ padding: "2rem 1.5rem", background: "#0a0a0a" }}>
                  <p style={{ fontSize: "clamp(1.8rem,3vw,2.8rem)", fontWeight: 700, color: "#ff6600", letterSpacing: "-.04em", lineHeight: 1 }}>{s.n}</p>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem,3.5vw,3.2rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem", maxWidth: 700 }}>
              144 problems. But the<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>roadmap was the real problem.</em>
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "5rem", alignItems: "center" }}>
              <div>
                <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem" }}>
                  I showed the cost<br />of <em style={{ color: "#ff6600", fontStyle: "italic" }}>waiting 6 months.</em>
                </h2>
                <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
                  ...
                  <div key={i} style={{
                    padding: "1.5rem",
                    border: `1px solid ${r.active ? "rgba(255,102,0,.4)" : "rgba(255,255,255,.08)"}`,
                    borderRadius: 12,
                    background: r.active ? "rgba(255,102,0,.06)" : "transparent",
                  }}>
                    <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".12em", color: r.active ? "#ff6600" : "rgba(255,255,255,.3)", textTransform: "uppercase", marginBottom: ".5rem" }}>{r.tag}</p>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem", maxWidth: 600 }}>
              Broken stepper, duplicate buttons,<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>no patterns, no guidance.</em>
            </h2>
            <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, maxWidth: 660, marginBottom: "4rem" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "5rem", alignItems: "center" }}>
              <div>
                <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem" }}>
                  CO ≠ MX ≠ BR.<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>Testing all three prevented rework.</em>
                </h2>
                <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                    <div style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(255,102,0,.15)", border: "1px solid rgba(255,102,0,.3)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <span style={{ fontSize: ".9rem", fontWeight: 700, color: "#ff6600" }}>{c.n}</span>
                    </div>
                    <div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem", maxWidth: 700 }}>
              4 domains → 1.<br />Linear and forced → <em style={{ color: "#ff6600", fontStyle: "italic" }}>free dashboard.</em>
            </h2>
            <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, maxWidth: 660, marginBottom: "4rem" }}>
          ...
          <ScrollReveal delay={100}>
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "2rem", marginBottom: "4rem" }}>
              ...
              <div style={{ padding: "2rem", border: "1px solid rgba(255,102,0,.25)", borderRadius: 16, background: "rgba(255,102,0,.04)" }}>
                <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".12em", color: "#ff6600", textTransform: "uppercase", marginBottom: "1.25rem" }}>After</p>
                {["Sign up · Qualified lead · 5 min", "Dashboard · merchants choose any order", "Bank · Hours · Logo · Docs · Menu", "Platform onboarding · Store live"].map((step, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: ".75rem", marginBottom: ".75rem" }}>
                    <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#ff6600", flexShrink: 0 }} />
                    <p style={{ fontSize: ".85rem", color: "rgba(255,255,255,.65)" }}>{step}</p>
                  </div>
                ))}
                <p style={{ fontSize: ".8rem", color: "#ff6600", marginTop: "1.25rem", fontStyle: "italic" }}>1 unified domain · no transitions</p>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: "5rem", alignItems: "center" }}>
              <div>
                <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem" }}>
                  4 broken pages → <br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>1 seamless animation.</em>
                </h2>
                <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, marginBottom: "1.5rem" }}>
      ...
      <section style={{ padding: pad }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem,3vw,3rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1.5rem", maxWidth: 700 }}>
              Menu management went from<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>days to a few hours.</em>
            </h2>
            <p style={{ fontSize: "1rem", color: "rgba(255,255,255,.55)", lineHeight: 1.8, maxWidth: 660, marginBottom: "4rem" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <ScrollReveal>
            ...
            <h2 style={{ fontSize: "clamp(2rem,3.5vw,3.2rem)", fontWeight: 700, color: "#fff", letterSpacing: "-.03em", lineHeight: 1.05, marginBottom: "1rem", maxWidth: 700 }}>
              3 releases. 3 markets.<br /><em style={{ color: "#ff6600", fontStyle: "italic" }}>Numbers that moved the business.</em>
            </h2>
          ...
          {/* Big metric */}
          <ScrollReveal delay={100}>
            <div style={{ padding: "3rem", border: "1px solid rgba(255,102,0,.3)", borderRadius: 20, background: "rgba(255,102,0,.05)", marginBottom: "2rem", textAlign: "center" }}>
              <p style={{ fontSize: ".75rem", fontWeight: 600, letterSpacing: ".15em", color: "#ff6600", textTransform: "uppercase", marginBottom: "1rem" }}>Time to open a store</p>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "2rem", flexWrap: "wrap" }}>
                ...
                <p style={{ fontSize: "clamp(2rem,5vw,4rem)", color: "#ff6600" }}>→</p>
            ...
            {[
              ...
              <ScrollReveal key={i} delay={i * 80}>
                <div style={{ padding: "2.5rem 2rem", background: "#0a0a0a", height: "100%" }}>
                  <p style={{ fontSize: "clamp(2rem,3.5vw,3rem)", fontWeight: 700, color: "#ff6600", letterSpacing: "-.04em", lineHeight: 1, marginBottom: ".75rem" }}>{m.n}</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(2,1fr)", gap: "2rem" }}>
              {[
                ...
                <div key={i} style={{ padding: "2rem", border: "1px solid rgba(255,255,255,.07)", borderRadius: 16 }}>
                  <p style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".15em", color: "#ff6600", textTransform: "uppercase", marginBottom: "1rem" }}>{l.n}</p>
      ...
      <footer style={{ background: "#000", borderTop: "1px solid rgba(255,255,255,.08)", padding: "2rem 6rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "2rem" }}>
          <Link href="/work/cvc" style={{ fontSize: ".72rem", color: "#ff6600", textDecoration: "none" }}>← CVC</Link>
